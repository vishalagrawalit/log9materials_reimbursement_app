...
public class ApplyForIntercity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_for_intercity);
    ...
    public void journeyTicketUpload(View view){
        final CharSequence[] items = { "Take Photo", "Choose from Library",
                "Cancel" };
        AlertDialog.Builder builder = new AlertDialog.Builder(ApplyForIntercity.this);
    ...
    public void cameraIntent() {
        int permissionCheck = ContextCompat.checkSelfPermission(ApplyForIntercity.this,
        ...
        if(permissionCheck == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(ApplyForIntercity.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_CAMERA: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ApplyForIntercity.this, "Camera Permission Granted", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ApplyForIntercity.this, "Camera Permission Denied. You can't use camera for this task.", Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode) {
            ...
            case CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE:
                ...
                if(resultCode == RESULT_OK) {
                    ...
                    Toast.makeText(ApplyForIntercity.this, "An error occured.", Toast.LENGTH_SHORT).show();
                }
                Toast.makeText(ApplyForIntercity.this, "Image selected", Toast.LENGTH_SHORT).show();
                break;
            case REQUEST_CAMERA:
                if (resultCode == RESULT_OK) {
                    Log.d("Image", "clicked");
    ...
    public void uploadImage(final String imageName,final Class<? extends Activity> xyz) {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(ApplyForIntercity.this, "Error in uploading!", Toast.LENGTH_SHORT).show();
                mProgress.dismiss();
            }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(ApplyForIntercity.this, "Image successfully uploaded", Toast.LENGTH_SHORT).show();
                updateDatabase(xyz);
            }
        });
    }
    ...
    public void switchActivity (final Class<? extends Activity> xyz) {
        ...
        Intent intent = new Intent(ApplyForIntercity.this, xyz);
    ...
    public void updateDatabase(Class<? extends Activity> xyz){
        ...
        mReimbursementRef.child("type").setValue("intercity");
