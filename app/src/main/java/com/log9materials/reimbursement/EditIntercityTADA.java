...
public class EditIntercityTADA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_intercity_tad);
        ...
        Log.v("Reimbursement", ta_da_pushId);
        ta_da_pushId = String.valueOf(Integer.valueOf(ta_da_pushId)+1);
        mDatabase.getReference("Reimbursement").child(user_employee_id).child(number_of_reimbursement_applied).child(ta_da_pushId).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void journeySaveChanges(View view){
        ...
        Intent intent = new Intent(EditIntercityTADA.this, FinalSubmitTaDa.class);
